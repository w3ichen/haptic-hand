 ...
 *
 */
public class BSpline3D extends AbstractPath {

	protected BCurve3D[] bcurve3d;
...
//	 */
//	public BSpline3D(float[] x, float[] y){
//		this(Util.makePVectorArray(x, y));
//	}
//
//	/**
//	 * Creates a Bezier spline using three arrays for the x, y and z 
//	 * positions for each control point.<br>
//	 * If the arrays passed to this constructor differ in length the extra 
//	 * in the longer array are ignored. <br>
//	 * 
//	 * @param x array of the x values of the control point positions
//	 * @param y array of the y values of the control point positions
//	 * @param z array of the z values of the control point positions
//	 * @param nbrSlices the number of slices along the curve's length
//	 */
//	public BSpline3D(float[] x, float[] y, float[] z){
//		this(Util.makePVectorArray(x, y));
//	}
//
//	/**
...
//	 */
//	public BSpline3D(List<PVector> knots) {
//		this(knots, null);
//	}
//
//	/**
...
//	 * @param ortho the orthogonal calculator to use
//	 */
//	public BSpline3D(List<PVector> knots, PathOrthogonal ortho) {
...
//	 * @param nbrSlices the number of slices along the length of the path
//	 */
//	public BSpline3D(PVector[] knots) {
//		this(knots, null);
//	}
//
//	/**
...
//	 * @param ortho the orthogonal calculator to use
//	 */
//	public BSpline3D(PVector[] knots, PathOrthogonal ortho) {
//		super();
...
//	}
	 ...
	 * @param nbrSlices the number of slices along the curve's length
	 */
	public BSpline3D(float[] x, float[] y, int nbrSlices){
	 ...
	 * @param nbrSlices the number of slices along the curve's length
	 */
	public BSpline3D(float[] x, float[] y, float[] z, int nbrSlices){
		this(Util.makePVectorArray(x, y), nbrSlices);
	}
	 ...
	 * @param ortho the orthogonal calculator to use
	 */
	public BSpline3D(List<PVector> knots, int nbrSlices) {
	 ...
	 * @param ortho the orthogonal calculator to use
	 */
	public BSpline3D(List<PVector> knots, int nbrSlices, PathOrthogonal ortho) {
	 ...
	 * @param nbrSlices the number of slices along the length of the path
	 */
	public BSpline3D(PVector[] knots, int nbrSlices) {
		this(knots, nbrSlices, null);
	}
	 ...
	 * @param ortho the orthogonal calculator to use
	 */
	public BSpline3D(PVector[] knots, int nbrSlices, PathOrthogonal ortho) {
		super(nbrSlices);
		calculateSpline(knots);
		orthoCalculator = ortho;
	}
	...
	private void calculateSpline(PVector[] knots){
		...
		bcurve3d = new BCurve3D[n];
		float[] bcurveLength = new float[n];
		for(int i = 0; i < n; i++){
			bcurve3d[i] = new BCurve3D( new PVector[] {knots[i], p1[i], p2[i], knots[i+1] } , 4);
