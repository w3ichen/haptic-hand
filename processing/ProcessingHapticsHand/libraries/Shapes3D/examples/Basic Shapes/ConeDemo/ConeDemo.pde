/**
 * ===============================================
 * Simple double-cone with shape pciking
 * ===============================================
 * 
 * This sketch creates a double cone with the 2
 * different orthogonal radii and different heights.
 * It uses the default the shapes attributes wher the
 * two cones have different colours. 
 *
 * Also demonstrates
 *  - 3D shape picking
 * 
...
void setup() {
  ...
  shape = new DoubleCone(
    160, 100, // orthogonal radii at the shared wide end
    50, -80,  // height of the 2 cones
    18        // The number of segments round the cone
    );
}
