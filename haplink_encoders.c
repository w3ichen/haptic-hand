...
#define M4_S1_PIN                 GPIOPin9
#define M4_S2_PIN                 GPIOPin8
#define M5_S1_PIN                 GPIOPin7
#define M5_S2_PIN                 GPIOPin6
#define M6_S1_PIN                 GPIOPin4
#define M6_S2_PIN                 GPIOPin3
#define M7_S1_PIN                 GPIOPin2
#define M7_S2_PIN                 GPIOPin1
...
void initHapticHandEncodersMotors( void )
{
    ...
    /* FINGER MOTOR ENCODERS */

    gpioinitstructure.GPIO_Mode = GPIOModeIN; // recall external interrupts are first initialized as inputs
    gpioinitstructure.GPIO_OType = GPIOOTypePP;
    gpioinitstructure.GPIO_Speed = GPIOHighSpeed;
    gpioinitstructure.GPIO_PuPd = GPIOPuPdNOPULL;

    gpioinitstructure.GPIO_Pin = GPIOPin9;
    GPIOInit((GPIOTypeDef *)GPIOE_BASE_MORT, &gpioinitstructure);
    gpioinitstructure.GPIO_Pin = GPIOPin8;
    GPIOInit((GPIOTypeDef *)GPIOE_BASE_MORT, &gpioinitstructure);
    gpioinitstructure.GPIO_Pin = GPIOPin7;
    GPIOInit((GPIOTypeDef *)GPIOE_BASE_MORT, &gpioinitstructure);
    gpioinitstructure.GPIO_Pin = GPIOPin6;
    GPIOInit((GPIOTypeDef *)GPIOE_BASE_MORT, &gpioinitstructure);
    gpioinitstructure.GPIO_Pin = GPIOPin4;
    GPIOInit((GPIOTypeDef *)GPIOE_BASE_MORT, &gpioinitstructure);
    gpioinitstructure.GPIO_Pin = GPIOPin3;
    GPIOInit((GPIOTypeDef *)GPIOE_BASE_MORT, &gpioinitstructure);
    gpioinitstructure.GPIO_Pin = GPIOPin2;
    GPIOInit((GPIOTypeDef *)GPIOE_BASE_MORT, &gpioinitstructure);
    gpioinitstructure.GPIO_Pin = GPIOPin1;
    GPIOInit((GPIOTypeDef *)GPIOE_BASE_MORT, &gpioinitstructure);

    M4p_s1 = GPIOReadInputDataBit( (GPIOTypeDef *)GPIOE_BASE_MORT, M4_S1_PIN);
    M4p_s2 = GPIOReadInputDataBit( (GPIOTypeDef *)GPIOE_BASE_MORT, M4_S2_PIN);
    M4_s1 = M4p_s1;
    M4_s2 = M4p_s2;

    M5p_s1 = GPIOReadInputDataBit( (GPIOTypeDef *)GPIOE_BASE_MORT, M5_S1_PIN);
    M5p_s2 = GPIOReadInputDataBit( (GPIOTypeDef *)GPIOE_BASE_MORT, M5_S2_PIN);
    M5_s1 = M5p_s1;
    M5_s2 = M5p_s2;
...
{
    if(EXTI_GetITStatus_mort(EXTI_Line9_MORT) != RESET_MORT) // motor 4 sensor 1
    {
    ...
    else if(EXTI_GetITStatus_mort(EXTI_Line8_MORT) != RESET_MORT) // motor4 sensor 2
    {
        M4_s1 = (GPIOReadInputDataBit((GPIOTypeDef *)GPIOE_BASE_MORT, M4_S1_PIN));
        M4_s2 = (GPIOReadInputDataBit(( GPIOTypeDef *)GPIOE_BASE_MORT, M4_S2_PIN));
        if (((M4p_s1 == M4p_s2)&&(M4_s1 == (!M4_s2)))||((M4_s1==M4_s2)&&(M4p_s1==(!M4p_s2))))
...
{
    if(EXTI_GetITStatus_mort(EXTI_Line2_MORT) != RESET_MORT) // motor 6 sensor 1
    {
...
{
    if(EXTI_GetITStatus_mort(EXTI_Line1_MORT) != RESET_MORT) // motor 6 sensor 1
    {
        M7_s1 = (GPIOReadInputDataBit((GPIOTypeDef *)GPIOE_BASE_MORT, M7_S1_PIN));
        M7_s2 = (GPIOReadInputDataBit((GPIOTypeDef *)GPIOE_BASE_MORT, M7_S2_PIN));
        if (((M7p_s1 == M7p_s2)&&(M7_s1 == (!M7_s2)))||((M7_s1==M7_s2)&&(M7p_s1==(!M7p_s2))))
