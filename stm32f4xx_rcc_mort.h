...
/** @defgroup RCC_LSE_Dual_Mode_Selection
  * @{
  */
#define RCC_LSE_LOWPOWER_MODE_MORT           ((uint8_t)0x00)
#define RCC_LSE_HIGHDRIVE_MODE_MORT          ((uint8_t)0x01)
#define IS_RCC_LSE_MODE_MORT(MODE)           (((MODE) == RCC_LSE_LOWPOWER_MODE_MORT) || \
                                         ((MODE) == RCC_LSE_HIGHDRIVE_MODE_MORT))
/**
  * @}
  */
...
/** @defgroup RCC_Interrupt_Source 
  * @{
  */
#define RCC_IT_LSIRDY_MORT                    ((uint8_t)0x01)
#define RCC_IT_LSERDY_MORT                    ((uint8_t)0x02)
#define RCC_IT_HSIRDY_MORT                    ((uint8_t)0x04)
#define RCC_IT_HSERDY_MORT                    ((uint8_t)0x08)
#define RCC_IT_PLLRDY_MORT                    ((uint8_t)0x10)
#define RCC_IT_PLLI2SRDY_MORT                 ((uint8_t)0x20) 
#define RCC_IT_PLLSAIRDY_MORT                 ((uint8_t)0x40)
#define RCC_IT_CSS_MORT                       ((uint8_t)0x80)

#define IS_RCC_IT(IT) ((((IT) & (uint8_t)0x80) == 0x00) && ((IT) != 0x00))
#define IS_RCC_GET_IT(IT) (((IT) == RCC_IT_LSIRDY_MORT) || ((IT) == RCC_IT_LSERDY_MORT) || \
                           ((IT) == RCC_IT_HSIRDY_MORT) || ((IT) == RCC_IT_HSERDY_MORT) || \
                           ((IT) == RCC_IT_PLLRDY_MORT) || ((IT) == RCC_IT_CSS_MORT) || \
                           ((IT) == RCC_IT_PLLSAIRDY_MORT) || ((IT) == RCC_IT_PLLI2SRDY_MORT))
...
/** @defgroup RCC_Flag 
  * @{
  */
#define RCC_FLAG_HSIRDY_MORT                  ((uint8_t)0x21)
#define RCC_FLAG_HSERDY_MORT                  ((uint8_t)0x31)
#define RCC_FLAG_PLLRDY_MORT                 ((uint8_t)0x39)
#define RCC_FLAG_PLLI2SRDY_MORT              ((uint8_t)0x3B)
#define RCC_FLAG_PLLSAIRDY_MORT              ((uint8_t)0x3D)
#define RCC_FLAG_LSERDY_MORT                 ((uint8_t)0x41)
#define RCC_FLAG_LSIRDY_MORT                 ((uint8_t)0x61)
#define RCC_FLAG_BORRST_MORT                 ((uint8_t)0x79)
#define RCC_FLAG_PINRST_MORT                 ((uint8_t)0x7A)
#define RCC_FLAG_PORRST_MORT                 ((uint8_t)0x7B)
#define RCC_FLAG_SFTRST_MORT                 ((uint8_t)0x7C)
#define RCC_FLAG_IWDGRST_MORT                ((uint8_t)0x7D)
#define RCC_FLAG_WWDGRST_MORT                ((uint8_t)0x7E)
#define RCC_FLAG_LPWRRST_MORT                ((uint8_t)0x7F)

#define IS_RCC_FLAG(FLAG) (((FLAG) == RCC_FLAG_HSIRDY_MORT)   || ((FLAG) == RCC_FLAG_HSERDY_MORT) || \
